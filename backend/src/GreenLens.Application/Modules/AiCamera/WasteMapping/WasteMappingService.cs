...
public sealed class WasteMappingService : IWasteMappingService
{
    ...
    private static readonly IReadOnlyDictionary<string, WasteCategoryDto> LabelMappings =
        new Dictionary<string, WasteCategoryDto>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Tin"] = new(WasteCategories.Recyclable, "Green"),
            ["Tin Can"] = new(WasteCategories.Recyclable, "Green"),
            ...
            ["Cup"] = new(WasteCategories.Recyclable, "Green"),
            ["Container"] = new(WasteCategories.Recyclable, "Green"),
            ["Jar"] = new(WasteCategories.Recyclable, "Green"),
            ["Box"] = new(WasteCategories.Recyclable, "Green"),
            ["Wrapper"] = new(WasteCategories.Recyclable, "Green"),
            ["Packet"] = new(WasteCategories.Recyclable, "Green"),
            ["Packaging"] = new(WasteCategories.Recyclable, "Green"),
            ["Plastic Container"] = new(WasteCategories.Recyclable, "Green"),
            ["Foil"] = new(WasteCategories.Recyclable, "Green"),
