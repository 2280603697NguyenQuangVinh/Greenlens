...
import type { BuildParameters, BuildResult, CacheData, CacheManagerFactory, ChangeEventMetadata, Console, FileData, FileSystem, HasteMapData, HasteMapItem, HType, InputFileMapPlugin, PerfLoggerFactory } from "@expo/metro/metro-file-map/flow-types";
...
export { default as DependencyPlugin } from "@expo/metro/metro-file-map/plugins/DependencyPlugin";
export type { DependencyPluginOptions } from "@expo/metro/metro-file-map/plugins/DependencyPlugin";
