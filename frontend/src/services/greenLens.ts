  ...
  recycle: [
    {
      ...
      emoji: "🍶",
      options: ["Thùng tái chế", "Thùng hữu cơ", "Thùng rác nguy hại", "Chậu cây"],
      correctIndex: 0,
    ...
    },
    {
      ...
      emoji: "🧻",
      options: ["Vứt thùng tái chế", "Vứt rác thường", "Đốt ngay", "Bỏ vào chậu cây"],
      correctIndex: 1,
    ...
    },
    {
      ...
      emoji: "🌍",
      options: ["Để giảm rác chôn lấp", "Cho vui", "Không cần thiết", "Để làm rác bẩn hơn"],
      correctIndex: 0,
