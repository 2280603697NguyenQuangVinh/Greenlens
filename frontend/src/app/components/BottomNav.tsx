import { FF_COMFORTAA } from "../constants"
import type { AvatarConfig } from "../types"
import { AvatarPreview } from "./AvatarPreview"
import { getRootUiAsset } from "../uiAssets"

const NAV_HOME = getRootUiAsset("dashbroad homescreen.png")
const NAV_QUIZ = getRootUiAsset("dashbroad quiz.png")
const NAV_CAMERA = getRootUiAsset("dashbroad camera.png")
const NAV_MINIGAME = getRootUiAsset("dashbroad minigame.png")
