...
const EYES_LAYER = [
  new URL("../assets/Character/eyes color/black.png", import.meta.url).href,
  new URL("../assets/Character/eyes color/brown.png", import.meta.url).href,
...
const MALE_HAIR = [
  new URL("../assets/Character/male/hair/hair_1.png", import.meta.url).href,
  new URL("../assets/Character/male/hair/hair_2.png", import.meta.url).href,
  new URL("../assets/Character/male/hair/hair_3.png", import.meta.url).href,
  new URL("../assets/Character/male/hair/hair_4.png", import.meta.url).href,
  new URL("../assets/Character/male/hair/hair_5.png", import.meta.url).href,
]

const MALE_CLOTHES = [
  new URL("../assets/Character/male/clothes/clothes_1.png", import.meta.url).href,
  new URL("../assets/Character/male/clothes/clothes_2.png", import.meta.url).href,
  new URL("../assets/Character/male/clothes/clothes_3.png", import.meta.url).href,
  new URL("../assets/Character/male/clothes/clothes_4.png", import.meta.url).href,
  new URL("../assets/Character/male/clothes/clothes_5.png", import.meta.url).href,
]

const MALE_MODEL_MODULES = (import.meta as any).glob("../assets/Character/male/model/model_*.png", { eager: true, as: "url" }) as Record<string, string>
...
const FEMALE_HAIR = [
  new URL("../assets/Character/female/hair/hair_1.png", import.meta.url).href,
  new URL("../assets/Character/female/hair/hair_2.png", import.meta.url).href,
  new URL("../assets/Character/female/hair/hair_3.png", import.meta.url).href,
  new URL("../assets/Character/female/hair/hair_4.png", import.meta.url).href,
  new URL("../assets/Character/female/hair/hair_5.png", import.meta.url).href,
]

const FEMALE_CLOTHES = [
  new URL("../assets/Character/female/clothes/clothes_1.png", import.meta.url).href,
  new URL("../assets/Character/female/clothes/clothes_2.png", import.meta.url).href,
  new URL("../assets/Character/female/clothes/clothes_3.png", import.meta.url).href,
  new URL("../assets/Character/female/clothes/clothes_4.png", import.meta.url).href,
  new URL("../assets/Character/female/clothes/clothes_5.png", import.meta.url).href,
]

const FEMALE_MODEL_MODULES = (import.meta as any).glob("../assets/Character/female/model/model_*.png", { eager: true, as: "url" }) as Record<string, string>
