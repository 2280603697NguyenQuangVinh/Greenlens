...
function StreakSkeleton() {
  return (
    <div className="mb-3">
      ...
      <div className="animate-pulse overflow-hidden rounded-[1.75rem] border border-white/60 bg-white/50 p-4">
...
export function StreakSection({
  ...
  return (
    <section className="relative mb-3">
      ...
      <div className="overflow-hidden rounded-[1.75rem] border border-white/60 bg-white/95 shadow-[0_8px_32px_rgba(45,106,79,0.1)] backdrop-blur-sm">
        <div className="p-4">
          <div className="rounded-[1.35rem] border border-emerald-200/60 bg-[#ecfdf5]/90 p-4 shadow-[0_4px_16px_rgba(82,183,136,0.12)]">
