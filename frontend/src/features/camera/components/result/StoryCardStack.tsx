    ...
    <div className="mb-1 space-y-2">
      {cards.map((card, index) => (
        <motion.article
          ...
          className={`rounded-[22px] border-2 p-3 shadow-[0_4px_14px_rgba(0,0,0,0.05)] ${card.bg} ${card.tilt}`}
        >
          <div className="flex items-start gap-2.5">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/70 text-xl shadow-sm">
              {card.emoji}
            </span>
