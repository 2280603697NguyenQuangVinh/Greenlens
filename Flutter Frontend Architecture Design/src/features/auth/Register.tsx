  ...
  return (
    <div className="flex flex-col min-h-screen bg-green-50 px-6 py-12">
      <div className="flex flex-col items-center mt-8 mb-10">
        ...
        <h1 className="text-4xl font-black text-green-900">Join GreenLens</h1>
        <p className="text-green-600 font-semibold mt-2 text-lg">Create your explorer account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5 w-full max-w-sm mx-auto">
        <label className="flex flex-col gap-2">
          ...
          <div className="relative">
            <User className="absolute left-4 top-1/2 -translate-y-1/2 text-green-400" size={20} />
            <input
              type="text"
              value={name}
      ...
      <p className="mt-8 text-center text-green-700 font-semibold">
        ...
        <Link to="/login" className="text-green-500 underline underline-offset-4">
          Sign in
        </Link>
      </p>
    </div>
